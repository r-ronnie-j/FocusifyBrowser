...
enum class SpinWebCategory(val value: Int) {
    ...
    VPNProxy(1058),
    Nudity(1052),
    AlcoholAndTobacco(1076),
    ProneToPorn(10002),
    Youtube(10005),
    CultAndOccult(1008),
    WebAds(1052),
    SocialNetworking(1014),
    Plagiarism(1053),
    Dating(1018),
    Gross(1054),
    SexEducation(1019),
    MalwareSites(1056),
    Religion(1020),
    PhishingAndFrauds(1057),
    EntertainmentAndArts(1021),
    SpywareAndAdware(1059),
    PersonalSitesAndBlogs(1022),
    Illegal(1064),
    StreamingMedia(1025),
    InternetCommunications(1066),
    JobSearch(1026),
    Botnets(1067),
    SharewareAndFreeware(1030),
    Abortion(1068),
    Hacking(1033),
    HealthAndMedicine(1069),
    Games(1034),
    SpamURLs(1072),
    Weapons(1036),
    ParkedDomains(1075),
    PayToSurf(1037),
    ImageAndVideoSearch(1078),
    HuntingAndFishing(1038),
    FashionAndBeauty(1079),
    Questionable(1044),
    WebHostingSites(2002),
    HateAndRacism(1046),
    PersonalStorage(1047),
    ViolenceAndSuicide(1048),
    KeyloggersAndMonitoring(1049),
    SearchEngines(1050),
    ProneToBadContent(1000);
...
enum class BlocksiCategory(val value: Int) {
    ...
    DrugAbuse(200),
    Hacking(201),
    IllegalOrUnethical(202),
    Discrimination(203),
    ExplicitViolence(204),
    ExtremistGroups(205),
    ProxyAvoidance(206),
    Plagiarism(207),
    ChildAbuse(208),

    AlternativeBeliefs(300),
    Abortion(301),
    OtherAdultMaterials(302),
    AdvocacyOrganizations(303),
    Gambling(304),
    NudityAndRisque(305),
    Pornography(306),
    Dating(307),
    ...
    Alcohol(311),
    Tobacco(312),
    LingerieAndSwimsuit(313),
    SportsHuntingAndWarGames(314),

    FreewareAndSoftwareDownloads(400),
    FileSharingAndStorage(401),
    StreamingMediaAndDownload(402),
    PeerToPeerFileSharing(403),
    InternetRadioAndTV(404),
    InternetTelephony(405),

    FinanceAndBanking(500),
    SearchEnginesAndPortals(501),
    GeneralOrganizations(502),
    Business(503),
    InformationAndComputerSecurity(504),
    GovernmentAndLegalOrganizations(505),
    InformationTechnology(506),
    ArmedForces(507),
    WebHosting(508),
    SecureWebsites(509),
    WebBasedApplications(510),

    Advertising(600),
    BrokerageAndTrading(601),
    Games(602),
    WebBasedEmail(603),
    Entertainment(604),
    ArtsAndCulture(605),
    Education(606),
    HealthAndWellness(607),
    JobSearch(608),
    Medicine(609),
    NewsAndMedia(610),
    SocialNetworking(611),
    PoliticalOrganizations(612),
    Reference(613),
    GlobalReligion(614),
    ShoppingAndAuction(615),
    SocietyAndLifestyles(616),
    Sports(617),
    Travel(618),
    PersonalVehicles(619),
    DynamicContent(620),
    MeaninglessContent(621),
    Folklore(622),
    WebChat(623),
    InstantMessaging(624),
    NewsgroupsAndMessageBoards(625),
    DigitalPostcards(626),
    ChildEducation(627),
    RealEstate(628),
    RestaurantAndDining(629),
    PersonalWebsitesAndBlogs(630),
    ContentServers(631),
    DomainParking(632),
    PersonalPrivacy(633);
...
val categoryList = listOf(
    ...
    WebCategory(
        name = "Alcohol, Cigarette and Tobacco",
        ...
        blocksi = listOf(
            BlocksiCategory.Tobacco,
            BlocksiCategory.Tobacco,
            BlocksiCategory.Marijuana
        )
    ),
    WebCategory(
