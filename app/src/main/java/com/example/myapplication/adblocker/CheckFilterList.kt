...
class CheckFilterList {
    fun checkFilterList(
        currentDomain: String?,
        resourceUrl: String,
        isThirdPartyRequest: Boolean,
        filterList: ArrayList<List<Array<String>>>
    ): Array<String> {
...
//                3 -> if (resourceUrl.contains(allowListEntry[0]) && resourceUrl.contains(
//                        allowListEntry[1]
//                    )
//                ) {
//                    // Allow the request.
...
//                4 -> if (resourceUrl.contains(allowListEntry[0]) && resourceUrl.contains(
//                        allowListEntry[1]
//                    ) && resourceUrl.contains(allowListEntry[2])
//                ) {
//                    // Allow the request.
//                    return arrayOf(
//                        REQUEST_ALLOWED,
...
//                when (allowListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        )
//                    ) {
//                        // Allow the request.
...
//
//                    // There are two entries.
//                    4 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2])
//                    ) {
//                        // Allow the request.
...
//
//                    // There are three entries.
//                    5 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2]) && resourceUrl.contains(
//                            allowListEntry[3]
//                        )
//                    ) {
//                        // Allow the request.
...
//                    6 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2]) && resourceUrl.contains(
//                            allowListEntry[3]
//                        ) &&
...
//                when (allowListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.startsWith(
//                            allowListEntry[1]
//                        )
//                    ) {
//                        // Allow the request.
...
//
//                    // There are two entries.
//                    4 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.startsWith(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2])
//                    ) {
//                        // Allow the request.
...
//
//                    // There are three entries.
//                    5 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.startsWith(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2]) && resourceUrl.startsWith(
//                            allowListEntry[3]
//                        )
//                    ) {
//                        // Allow the request.
...
//                when (allowListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.endsWith(
//                            allowListEntry[1]
//                        )
//                    ) {
//                        // Allow the request.
...
//                    4 -> if (currentDomain.endsWith(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.endsWith(allowListEntry[2])
//                    ) {
//                        // Allow the request.
//                        return arrayOf(
//                            REQUEST_ALLOWED,
...
//
//                    // There are four entries.
//                    5 -> if (resourceUrl.contains(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2]) && resourceUrl.contains(
//                            allowListEntry[3]
//                        )
...
//                    6 -> if (resourceUrl.contains(allowListEntry[0]) && resourceUrl.contains(
//                            allowListEntry[1]
//                        ) && resourceUrl.contains(allowListEntry[2]) && resourceUrl.contains(
//                            allowListEntry[3]
//                        ) &&
...
//                            resourceUrl,
//                            filterListName,
//                            THIRD_PARTY_DOMAIN_INITIAL_ALLOWLIST,
//                            "${allowListEntry[0]}\n${allowListEntry[1]}\n",
//                            allowListEntry[2]
//                        )
//                    }
...
//
//                // There are two entries.
//                3 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    )
//                ) {
//                    // Block the request.
...
//
//                // There are three entries.
//                4 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    ) && resourceUrl.contains(blockListEntry[2])
//                ) {
//                    // Block the request.
//                    return arrayOf(
//                        REQUEST_BLOCKED,
...
//
//                // There are four entries.
//                5 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    ) && resourceUrl.contains(blockListEntry[2]) && resourceUrl.contains(
//                        blockListEntry[3]
//                    )
//                ) {
//                    // Block the request.
...
//
//                // There are five entries.
//                6 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    ) && resourceUrl.contains(blockListEntry[2]) && resourceUrl.contains(
//                        blockListEntry[3]
//                    ) &&
...
//
//                // There are two entries
//                3 -> if (resourceUrl.startsWith(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    )
//                ) {
//                    // Block the request.
...
//
//                // There are two entries.
//                3 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.endsWith(
//                        blockListEntry[1]
//                    )
//                ) {
//                    // Block the request.
...
//                4 -> if (resourceUrl.contains(blockListEntry[0]) && resourceUrl.contains(
//                        blockListEntry[1]
//                    ) && resourceUrl.endsWith(blockListEntry[2])
//                ) {
//                    // Block the request.
//                    return arrayOf(
//                        REQUEST_BLOCKED,
...
//                when (blockListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain.endsWith(blockListEntry[0]) && resourceUrl.contains(
//                            blockListEntry[1]
//                        )
//                    ) {
//                        // Block the request.
...
//
//                    // There are two entries.
//                    4 -> if (currentDomain.endsWith(blockListEntry[0]) && resourceUrl.contains(
//                            blockListEntry[1]
//                        ) && resourceUrl.contains(blockListEntry[2])
//                    ) {
//                        // Block the request.
...
//
//                    // There are three entries.
//                    5 -> if (currentDomain.endsWith(blockListEntry[0]) && resourceUrl.contains(
//                            blockListEntry[1]
//                        ) && resourceUrl.contains(blockListEntry[2]) && resourceUrl.contains(
//                            blockListEntry[3]
//                        )
...
//                if (currentDomain.endsWith(blockListEntry[0]) && resourceUrl.startsWith(
//                        blockListEntry[1]
//                    )
//                ) {
//                    // Block the request.
...
//                when (blockListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain.endsWith(blockListEntry[0]) && resourceUrl.endsWith(
//                            blockListEntry[1]
//                        )
//                    ) {
//                        // Block the request.
...
//                if (currentDomain.endsWith(blockListEntry[0]) && Pattern.matches(
//                        blockListEntry[1],
//                        resourceUrl
//                    )
//                ) {
...
//                        resourceUrl,
//                        filterListName,
//                        DOMAIN_REGULAR_EXPRESSION_BLOCKLIST,
//                        "${blockListEntry[0]}\n${blockListEntry[1]}",
//                        blockListEntry[2]
//                    )
//                }
...
//                when (blockListEntry.size) {
//                    // There is one entry.
//                    3 -> if (currentDomain!!.endsWith(blockListEntry[0]) && resourceUrl.startsWith(
//                            blockListEntry[1]
//                        )
//                    ) {
//                        // Block the request.
...
//                            resourceUrl,
//                            filterListName,
//                            THIRD_PARTY_DOMAIN_INITIAL_BLOCKLIST,
//                            "${blockListEntry[0]}\n${blockListEntry[1]}\n",
//                            blockListEntry[2]
//                        )
//                    }
//
//                    // There are two entries.
//                    4 -> if (currentDomain!!.endsWith(blockListEntry[0]) && resourceUrl.startsWith(
//                            blockListEntry[1]
//                        ) && resourceUrl.contains(blockListEntry[2])
//                    ) {
//                        // Block the request.
...
//
//                    // There are three entries.
//                    5 -> if (currentDomain!!.endsWith(blockListEntry[0]) && resourceUrl.startsWith(
//                            blockListEntry[1]
//                        ) && resourceUrl.contains(blockListEntry[2]) && resourceUrl.contains(
//                            blockListEntry[3]
//                        )
...
//                        resourceUrl,
//                        filterListName,
//                        THIRD_PARTY_REGULAR_EXPRESSION_BLOCKLIST,
//                        blockListEntry[0],
//                        blockListEntry[1]
//                    )
//                }
...
//                        resourceUrl,
//                        filterListName,
//                        THIRD_PARTY_DOMAIN_REGULAR_EXPRESSION_BLOCKLIST,
//                        "${blockListEntry[0]}\n${blockListEntry[1]}",
//                        blockListEntry[2]
//                    )
//                }
//            }
//        }
        Log.d("adblock", "filter name $filterListName")
